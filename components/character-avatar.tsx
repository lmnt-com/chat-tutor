...
export function CharacterAvatar({
  ...
  const avatars = {
    [CharacterId.Fiona]: (
      <div
        className={`${sizeClasses[size]} ${className} rounded-full bg-gradient-to-br from-purple-200 via-pink-200 to-blue-200 flex items-center justify-center border-2 border-white shadow-lg relative overflow-hidden`}
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          ...
          {/* Hair */}
          <path
            d="M20 45 Q20 20 50 20 Q80 20 80 45 Q85 50 80 60 L75 50 Q70 45 50 45 Q30 45 25 50 L20 60 Q15 50 20 45"
            fill="url(#fiona-hair)"
          />
    ...
    [CharacterId.Merlin]: (
      <div
        className={`${sizeClasses[size]} ${className} rounded-full bg-gradient-to-br from-purple-400 via-indigo-500 to-purple-600 flex items-center justify-center border-2 border-white shadow-lg relative overflow-hidden`}
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          <defs>
            <linearGradient
          ...
          {/* Wizard Hat */}
          <path
            d="M35 25 L50 5 L65 25 Q68 30 65 35 L35 35 Q32 30 35 25"
            fill="url(#merlin-hat)"
          />
          ...
          {/* Beard */}
          <path
            d="M30 60 Q35 65 50 68 Q65 65 70 60 Q72 70 65 75 Q50 80 35 75 Q28 70 30 60"
            fill="url(#merlin-beard)"
          />
    ...
    [CharacterId.Cassian]: (
      <div
        className={`${sizeClasses[size]} ${className} rounded-full bg-gradient-to-br from-slate-300 via-blue-200 to-slate-400 flex items-center justify-center border-2 border-white shadow-lg relative overflow-hidden`}
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          <defs>
            <linearGradient
          ...
          {/* Hair */}
          <path
            d="M25 40 Q25 25 50 25 Q75 25 75 40 Q78 45 75 50 Q70 45 65 42 Q60 40 50 40 Q40 40 35 42 Q30 45 25 50 Q22 45 25 40"
            fill="url(#cassian-hair)"
          />
    ...
    [CharacterId.Brody]: (
      <div
        className={`${sizeClasses[size]} ${className} rounded-full bg-gradient-to-br from-cyan-200 via-blue-300 to-teal-300 flex items-center justify-center border-2 border-white shadow-lg relative overflow-hidden`}
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          <defs>
          ...
          {/* Messy surfer hair */}
          <path
            d="M22 42 Q25 20 35 25 Q40 15 50 20 Q60 15 65 25 Q75 20 78 42 Q80 50 75 55 Q70 50 65 48 Q55 45 50 48 Q45 45 35 48 Q30 50 25 55 Q20 50 22 42"
            fill="url(#brody-hair)"
          />
          ...
          <path
            d="M15 80 Q25 75 35 80 Q45 85 55 80 Q65 75 75 80 Q85 85 95 80"
            stroke="#0EA5E9"
            strokeWidth="2"
            fill="none"
            opacity="0.6"
